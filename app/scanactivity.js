...
const ScanLogs = () => {
  ...
  const handleOpenMap = (log) => {
    if (log.latitude && log.longitude) {
      ...
      triggerLocalNotification("No Location", "Location data is not available for this scan");
    }
  };
      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalContainer}>
                ...
                <View style={styles.modalSection}>
                  ...
                  {selectedLog.latitude && selectedLog.longitude ? (
                    <TouchableOpacity 
                      ...
                      onPress={() => handleOpenMap(selectedLog)}
                    >
          ...
          <View style={styles.modalActions}>
            {selectedLog?.latitude && selectedLog?.longitude && (
              <TouchableOpacity 
                style={[styles.modalButton, styles.mapActionButton]}
                onPress={() => handleOpenMap(selectedLog)}
              >
                <Icon name="map" size={20} color="#FFFFFF" />
                <Text style={styles.mapActionButtonText}>Open in Map</Text>
              </TouchableOpacity>
            )}
            <TouchableOpacity 
