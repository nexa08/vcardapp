    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity style={styles.row} onPress={() => router.push("/staff")}>
            <Text style={styles.rowText}>Add Staff</Text>
            <Icon name="pencil" size={20} color="#4F46E5" />
          </TouchableOpacity>
          <TouchableOpacity style={styles.row} onPress={() => router.push("/manage")}>
            <Text style={styles.rowText}>Manage staff</Text>
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity style={styles.row} onPress={() => router.push("/managevcard")}>
            ...
            <Icon name="id-card" size={20} color="#4F46E5" />
          </TouchableOpacity>
          <TouchableOpacity style={styles.row} onPress={() => router.push("/allscans")}>
            <Text style={styles.rowText}>View All Scans</Text>
